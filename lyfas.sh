...
function web() {
#安装web云端
rm -rf /var/www/* && cd /var/www && wget -q https://raw.fastgit.org/Wpenga/FAS3.0/master/fas_web.zip #http://lingyi3.nos-eastchina1.126.net/fas_web.zip #${http}${host}${ly863963860}fas_web.zip
...
Crackauthor="Wpenga";
http=https://
host=hub.fastgit.org/Wpenga/FAS3./FAS3.0/raw/
ly863963860=master/
logo
}
main
